...
--- Al no especificarse en el enunciado si la fecha es de alquiler o de devolución, he tomado la de alquiler y se observan 183 resultados con la misma fecha y hora.
...
select concat("Nombre", ' ',"Apellido") as actor_full_name,
       (
       select "name"
       from "category"
       where "name" = 'Action'
